...
<!--                        </a>-->
                    ...
                    <div class="text-wrapper">
                        <div class="top-section">
                            <div class="area-text"><span class="avail-text">City:</span> <?php echo $data_search['city'];?></div>
                            <div class="area-text"><span class="avail-text">Category:</span> <?php echo $data_search['cat_name'];?></div>
