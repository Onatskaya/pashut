...
$que_job="SELECT * FROM jobs ORDER BY job_id DESC ";
$obj_job= mysqli_query($conn,$que_job);
...
<div class="container">
	<div class="container locations">
		<div>
			<!-- <h3 style="background-color:#3D4D65;color:#fff;text-align:center;">Jobs</h3> -->
				...
				<div class="col-md-12">
						<table id="myTable" class="table table-striped dataTable table-bordered">                       
						    ...
						    <tbody>
						    	<?php
						    	$n=1;
						    		while($data_job=mysqli_fetch_assoc($obj_job))
						    		{  ?>
								        <tr>
								            <td><?php echo $n; ?></td>
								            <td><?php echo $data_job['first_name'];?>&nbsp;<?php echo $data_job['last_name'];?></td>
								            <td><?php echo $data_job['Email'];?></td>
								            <td><?php echo $data_job['telephone'];?></td>
								            <td><?php echo $data_job['degree']; ?></td>
								        	<td><a href="view_job_detail.php?jid=<?php echo $data_job['job_id'];?>" class="btn btn-danger">View Detail</a> </td>
								        </tr>
