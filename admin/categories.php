...
$que_post="SELECT * FROM `category` WHERE 1 ORDER BY `name`";
...
<!--                                        <a href="view_post_detail.php?pid=--><?php //echo $data_post['city_id'];?><!--" class="glyphicon glyphicon-eye-open"></a>-->
                                        <a href="edit_category.php?category_id=<?php echo $data_post['id'];?>" class="glyphicon glyphicon-pencil"></a>
                                        <a href="delete_category.php?category_id=<?php echo $data_post['id'];?>" data-href="edit_city.php?pid=<?php echo $data_post['id'];?>" class="glyphicon glyphicon-trash js-property-remove"></a>
                                    </td>
						        </tr>
