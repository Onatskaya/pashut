...
//            'contact_c' => $member['mem_phone_c'],
    ...
    $post += [
        ...
        'rent' => filter_var($data['price'], FILTER_SANITIZE_NUMBER_FLOAT),
...
//        'full_descp' => utf8_decode(htmlspecialchars(strip_tags($data['remarks']))),
        'full_descp' => htmlspecialchars(strip_tags($data['remarks'])),
