...
if(empty($data['property_zoom'])){
    $data['property_zoom'] = 6;
}

if(empty($data['property_lat'])){
    $data['property_lat'] = '31.046051';
}

if(empty($data['property_lng'])){
    $data['property_lng'] = '34.85161199999993';
}
?>
    ...
    <div class="flexslider" id="slider">
        ...
        <div class="flex-viewport" style="overflow: hidden; position: relative;">
            <ul class="slides" style="width: 2600%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                ...
                <?php for($i=1; $i<=5; $i++):?>
                    <?php $image_key = 'image' . $i; ?>
                    <?php if(!empty($data[$image_key])): ?>
                        <li style="width: 752px; float: left; display: block;"><img style="width:auto;" src="../home_images/<?php echo $data[$image_key];?>" draggable="false"></li>
                    <?php endif; ?>
                <?php endfor; ?>
        ...
        <div class="flex-viewport" style="overflow: hidden; position: relative;">
            <ul class="slides" style="width: 2600%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                ...
                <?php for($i=1; $i<=5; $i++):?>
                    <?php $image_key = 'image' . $i; ?>
                    <?php if(!empty($data[$image_key])): ?>
                        <li style="width: 210px; float: left; display: block;"><img src="../home_images/<?php echo $data[$image_key];?>" draggable="false"></li>
                    <?php endif; ?>
                <?php endfor; ?>
        ...
        <div class="listing-map">
            <div style="width: 280px; height: 230px; margin: 0px auto 15px; position: relative;">
                ...
                <div style='overflow:hidden;height:230px;width:280px;'>
                    ...
                    <div>
                        <small><a href="https://embedgooglemaps.com">
                                embed google maps
                            </a></small>
                    </div>
                    <div>
