...
$que_post="SELECT * FROM `city` WHERE 1 ORDER BY `city_name`";
	...
	<div class="container locations">
		...
		<center><h2>Cities</h2></center>
            <div class="remove-all-block" style="float: right; margin: 5px;">
                <a href="edit_city.php" class="btn btn-success" value="Add New">Add New</a>
<!--                <input type="submit" name="remove-all" class="btn btn-danger" value="Remove all">-->
<!--                <input type="submit" name="remove-checked" class="btn btn-danger" value="Remove checked">-->
            </div>
			<div class="row">
				    ...
				    <tbody>
				    	...
				    	$n=1;
				    		...
				    		{  ?>
						        <tr>
						            <td><?php echo $n; ?></td>
						            <td class="js-prop-name"><?php echo $data_post['city_name'];?></td>
<!--                                    <td><input type="checkbox" class="select-property" name="property_check[]" data-post_id="--><?php //echo $data_post['city_id'];?><!--"></td>-->
						        	<td>
<!--                                        <a href="view_post_detail.php?pid=--><?php //echo $data_post['city_id'];?><!--" class="glyphicon glyphicon-eye-open"></a>-->
                                        <a href="edit_city.php?city_id=<?php echo $data_post['city_id'];?>" class="glyphicon glyphicon-pencil"></a>
                                        <a href="delete_city.php?city_id=<?php echo $data_post['city_id'];?>" data-href="edit_city.php?pid=<?php echo $data_post['city_id'];?>" class="glyphicon glyphicon-trash js-property-remove"></a>
                                    </td>
						        </tr>
