	...
	<div class="col-md-12" align="center">
		...
		<div class="col-md-8 col-xs-12">
			...
			<div class="listing-info">
				...
				<div class="row odd">
					<div class="col-md-6">
						<strong>Phone No. </strong><?php echo $data['contact_a'];?>-<?php echo $data['contact_b'];?>-<?php echo $data['contact_c'];?>&nbsp;&nbsp;
                        <?php if(!empty($data['contact_d']) && $data['contact_d'] != '' ): ?>
                            Ext- <?php echo $data['contact_d'];?>
                        <?php endif; ?>
					</div>
					<!-- <div class="col-md-6">
						...
						<div class="col-md-4 col-xs-12">
							...
							<div class="address-info">
									...
									<a target="_blank" href="https://maps.google.com/maps?q=loc:<?php echo $data['property_lat'];?>,<?php echo $data['property_lng'];?>" class="gMapLink"> Open in Google Maps</a>
									<?php
									if(isset($_SESSION['member_logged']))
									{ ?>
...
<script src="js/jquery.min.js"></script>
    ...
    <?php include_once('member/member_init.php'); ?>
    </body>
</html>
