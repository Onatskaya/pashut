...
<div class="search-box">
	<h2><strong>!</strong>לחפש עכשיו<strong> בחינם</strong> </h2>
	<h4 style="color:#E92324;font-weight:bold;">!תגיד עמלות סוכן כדי להתראות</h4>
	...
	<div class="container-fluid ll-signup-area top">
		<div class="col-md-4">
			<div class="ft col-md-12" style="background-image: url('images/2016/plh-homepage_brokeragebanner.png'); min-height: 227px; background-size: 100%; background-repeat: no-repeat;">
				<ul>
					<li>אין עמלות סוכן</li>
					<li style="color:red;">!בעלי הקניין קבלו תשלום באמצעות כל אחת מרשומות </li>
					<li>תזמון & צופים נכס מידיים</li>
					<li>רישומים טרום מאושר & תמונות</li>
					<li>עודכן לפי שעה</li>
				</ul>
				<div class="img_a">
					<a href="sitemap.php">
