...
if($_SESSION['language']=='English')
{
	...
	echo "<script>location.href='change_password.php?$getto'</script>";
}
?>
<!DOCTYPE HTML> 
<html lang="en">
...
<div class="container">
	<div class="container locations">
		...
		<div class="col-md-8" align="center">
			<h2>שנה סיסמא</h2>
				<form action="save_change_password.php" method="POST" id="change_password">
				    <div class="row">
				        <div class="col-md-2"></div>
				        <div class="col-md-6"><input type="password" name="current_password" class="input validate[required] form-control"></div>
				        <label class="col-md-4">סיסמה נוכחית</label>
				    </div>
				    <br>
				    <div class="row">
				        <div class="col-md-2"></div>
						<div class="col-md-6"><input type="password" name="new_password" id="new_password" class="input validate[required] form-control"></div>
				        <label class="col-md-4">סיסמה חדשה</label>
				    </div>
				    <br>
				    <div class="row">
				        <div class="col-md-2"></div>
						<div class="col-md-6"><input type="password" name="re_password" class="input validate[required,equals[new_password]] form-control"></div>
				        <label class="col-md-4">אשר סיסמה</label>
				    </div>
				    <br>
				    <div class="row" align="center">
				        <input type="submit" style="width:120px;" class="btn" value="עדכון">
				    </div>
				</form>
