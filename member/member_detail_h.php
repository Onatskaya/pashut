...
if($_SESSION['language']=='English')
{
    ...
    echo "<script>location.href='member_detail.php?$getto'</script>";
}
    ...
    <div class="container locations">
        <div class="row" style="text-align: right;">
            ...
            <div class="col-md-10">
                ...
                { ?>
                    <div class="row"><h4 style="color:#3D4D65">פרטים בגוף שני:</h4></div>
                    <div class="row">
                ...
                { ?>
                    <div class="row"><h4 style="color:#3D4D65">פרטי אדם שולח:</h4></div>
                    <div class="row">
                ...
                ?>
                <div class="row">
                    <center><a href="edit_member_detail.php" class="btn btn-danger">לַעֲרוֹך</a></center>
                </div>
            </div>
