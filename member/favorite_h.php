...
if($_SESSION['language']=='English')
{
	...
	echo "<script>location.href='favorite.php?$getto'</script>";
}
				...
				<table id="myTable" class="table table-striped dataTable table-bordered">                       
				    <thead>
				        <tr>
			               ...
			               <th class="col-md-2">שֵׁם</th>
			               <th class="col-md-2">אֶלֶקטרוֹנִי</th>
			               <th class="col-md-2">עיר / אזור</th>
			               <th class="col-md-2">סוג המבנה</th>
			               <th class="col-md-2">מטר</th>
			               <th class="col-md-1">חדר שינה</th>
			               <th class="col-md-1">חדר אמבטיה</th>
			               <th class="col-md-1">מרוהט</th>
			               <th class="col-md-1">תמונה</th>
			               <th class="col-md-1">פעולה</th>
				        </tr>
				    </thead>
				    <tbody>
				    	<?php
				    		...
				    		{ 
				    		 ...
				    		 ?>
						        <tr>
						            ...
						            <td><?php $WHERE_CITY['city_id']=$data_fv['city']; echo select('city',$WHERE_CITY)[0]['city_name_he'];?></td>
						            <td><?php $WHERE_STRUCT['struct_id']=$data_fv['structure_type']; echo select('structure_type',$WHERE_STRUCT)[0]['name_he'];?></td>
						            <td><?php echo $data_fv['square_footage'];?> מטר</td>
						            <td><?php $WHERE_BEDROOM['id']=$data_fv['bedroom']; echo select('bedroom_tbl',$WHERE_BEDROOM)[0]['bedroom_he'];?></td>
						            <td><?php $WHERE_BATH['id']=$data_fv['bathroom']; echo select('bath_tbl',$WHERE_BATH)[0]['bath_he'];?></td>
						            <td><?php $WHERE_FUR['id']=$data_fv['furnished']; echo select('furnished',$WHERE_FUR)[0]['furnished_he'];?></td>
						            <td><img src="../home_images/<?php echo $data_fv['main_image'];?>" height="60" width="60"></td>
						        	<td><a href="view_detail.php?pid=<?php echo $data_fv['post_id'];?>" class="btn btn-danger">צפה בפרטים</a> </td>
						        </tr>
