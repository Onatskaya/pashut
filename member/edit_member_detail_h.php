...
if($_SESSION['language']=='English')
{
	...
	echo "<script>location.href='edit_member_detail.php?$getto'</script>";
}
		...
		<div class="row">
			...
			<form action="update_member.php" method="post" id="register">
				...
				<div class="row">
					...
					<label class="col-md-2">מספר כרטיס אשראי</label>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<select name="credit_card_exp_mo" class="form-control">
							<option <?php if($data_mem['credit_card_exp_mo']==01){ echo 'selected'; } ?> value="01">יָנוּאָר</option>
							<option <?php if($data_mem['credit_card_exp_mo']==02){ echo 'selected'; } ?> value="02">פברואר</option>
							<option <?php if($data_mem['credit_card_exp_mo']==03){ echo 'selected'; } ?> value="03">מרץ</option>
							<option <?php if($data_mem['credit_card_exp_mo']==04){ echo 'selected'; } ?> value="04">אַפּרִיל</option>
							<option <?php if($data_mem['credit_card_exp_mo']==05){ echo 'selected'; } ?> value="05">מאי</option>
							<option <?php if($data_mem['credit_card_exp_mo']==06){ echo 'selected'; } ?> value="06">יוני</option>
							<option <?php if($data_mem['credit_card_exp_mo']==07){ echo 'selected'; } ?> value="07">יולי</option>
							<option <?php if($data_mem['credit_card_exp_mo']==08){ echo 'selected'; } ?> value="08">אוגוסט</option>
							<option <?php if($data_mem['credit_card_exp_mo']==09){ echo 'selected'; } ?> value="09">סֶפּטֶמבֶּר</option>
							<option <?php if($data_mem['credit_card_exp_mo']==10){ echo 'selected'; } ?> value="10">אוֹקְטוֹבֶּר</option>
							<option <?php if($data_mem['credit_card_exp_mo']==11){ echo 'selected'; } ?> value="11">נוֹבֶמבֶּר</option>
							<option <?php if($data_mem['credit_card_exp_mo']==12){ echo 'selected'; } ?> value="12">דֵצֶמבֶּר</option>
						</select>
					</div>
					<label class="col-md-2">תאריך תפוגת הכרטיס</label>
				...
				{ ?>
					<div class="row"><h4 style="color:#3D4D65;text-align: right;">פרטים בגוף שני:</h4></div>
					<div class="row">
				...
				{ ?>
					<div class="row"><h4 style="color:#3D4D65;text-align: right;">פרטי אדם שולח:</h4></div>
					<div class="row">
				...
				?>
				<div class="row">
					<center><input type="submit" class="btn btn-danger" value="עדכון"></center>
				</div>
			</div>
			</form>
