	...
	<div class="col-md-12" align="center">
		...
		<div class="col-md-8">
			...
			<div class="listing-info">
				...
				<div class="row even">
					<div class="col-md-6">
						<strong>מטר : </strong><?php echo $data['square_footage'];?>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<strong>פנויות כותרת : </strong><?php echo $data['short_descp'];?>
					</div>
					<div class="col-md-6">
						<strong>חדר פנוי תיאור : </strong><?php echo $data['full_descp'];?>
					</div>
				</div>
				<div class="row even">
					<div class="col-md-6">
				...
				<div class="row even">
                    <?php if(isset($_SESSION['member_logged']) && is_active_member_plan( $conn )):  ?>
                        <div class="col-md-6" dir="ltr">
                            <strong>בטלפון. </strong><?php echo $data['contact_a'];?>-<?php echo $data['contact_b'];?>-<?php echo $data['contact_c'];?>&nbsp;&nbsp;
