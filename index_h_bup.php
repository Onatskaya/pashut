...
<div class="search-box">
	<h2>מודעות חדשות (24 שעות):</h2>
	<h4 style="color:#E92324;font-weight:bold;">תגידו שלום לעמלות סוכן!</h4>
	<form action="guestsearch_h.php" name="searchForm" method="GET">
		...
		<div class="line">
			...
			<select name="structure_type" style="width:32%;" class="medium right-pad">
				<option value="Apartments /Condos">דירות / דירות משותפות</option>
    							<option value="Houses /Guest Houses">בתים / בתי הארחהs</option>
    							<option value="Garages /Storage">אחסון</option>
    							<option value="Commercial/Offices">מסחרי / משרדים</option>
    							<option value="Lofts">לופטים</option>
    							<option value="Hotels">מלונות</option>
    							<option value="Other">אחר</option>
    							<option value="Roommates/Shares">שותפים</option>
    							<option value="Vacations/Short-Term">חופשות / טווח קצר</option>
			</select>
		
			<select name="priceLow" style="width:12%;" class="medium right-pad">
				<option value="">מסכום</option>
		...
		<input type="submit" name="search-submit" class="search" value="חפש" align="absmiddle" />
	...
	<form method="post" action="#" name="textCodeSearch">
		<input id="listing_id" class="text" type="text" name="listing_id" placeholder="חפש" />
		<input class="search-sm" type="submit" name="text-submit" value="חפש" />
	</form>
	</div>
</div>
...
<div class="search-box">
	...
	<div class="container-fluid ll-signup-area top">
		<div class="col-md-4">
			<div class="ft col-md-12" style="background-image: url('images/2016/plh-homepage_brokeragebanner.png'); min-height: 227px; background-size: 100%; background-repeat: no-repeat;">
				<ul>
					<li>ללא עמלות סוכן</li>
					<li style="color:red;">בעלי הנכס מרוויחים עבור כל מודעה!</li>
					<li>תיאום והצגה מיידיים של הנכס</li>
					<li>מודעות ותמונות מאושרות מראש</li>
					<li>מתעדכן בכל שעה</li>
				</ul>
				<div class="img_a">
					<a href="sitemap.php">
						למידע נוסף
		...
		<div class="col-md-4">
			<div class="ft col-md-12" style="background-image: url('images/2016/plh-homepage_rentpaybanner.png'); min-height: 227px; background-size: 100% ; background-repeat: no-repeat;">
				<div class="ld">
					<h2>בעלי נכס</h2>
					<p>פרסמו נכס להשכרה בחינם.</p>
					<p>התחילו עוד היום.</p>
				</div>
				<div class="img_a padd">
					<a href="post.php">למידע נוסף</a>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<p>"פשוט להשכיר" מחברים בין שוכרים לבעלי נכסים. פשוט.</p>
		...
		<p>אין אף עמלות סוכן עבור נכסים הרשומים באתר "פשוט להשכיר".אין אף עמלות סוכן עבור נכסים  הרשומים באתר "פשוט להשכיר".</p>
		<h2>כיצד זה עובד - שוכרים – בעלי נכס</h2>
		<ul>
			<li>האתר מספר לחבריו את המידע המדויק והמלא ביותר על נכסים בישראל. אנו מתמקדים במיוחד ברמה גבוהה של שביעות רצון של שוכרים המחפשים נכסים, ושל בעלי נכסים המעוניינים להשכיר את נכסיהם.
</li>
			<li>לשוכרים המצטרפים ל"פשוט להשכיר" מחכה ממשק פשוט ומסודר, חוויית משתמש נוחה, נייוט פשוט בין המודעות, ומידע מדויק על הנכסים השונים.
</li>
			<li>החברות באתר כוללת גישה חודשית לכל הנכסים הזמינים, תיאום מיידי של זמני הצגת נכסים, מודעות מעודכות בכל שעה, ומשאבים מקיפים עבור הובלות. חברות חודשית עולה 99 ₪ ל-30 ימים.
</li>
		</ul>
		<h2>כיצד זה עובד - שוכרים – בעלי נכס</h2>
		<ul>
			<li>בעלי נכסים יכולים לפרסם את הנכסים הזמינים שלהם בחינם, בכל יום. על כל מודעה לכלול תמונות ברורות ומדויקות של כל חדר, חדר שינה, שירותים ומרחבי מרפסות.
</li>
			<li>נדרשות לכל הפחות 5 תמונות, ותמונה אחת חיצונית של הבניין (יש אופציה להוספת סרטון), כדי לפרסם מודעה ב"פשוט להשכיר".
</li>
			<li>כל בעל נכס נדרש לקבוע את זמני הצגת הנכס בכל מודעה, כדי לאפשר לשוכרים גישה נוחה לבדיקת הנכס.
</li>
			<li>כאשר נכס הינו מושכר, הבלעים יכולים למחוק את המודעה על ידי לחיצה על כפתור ה"לא זמין" בתחתית עמוד הנכס שלהם.
