...
(function() {
	...
	<div class="llsignup">
		...
		<div style="text-align:right;font-weight: bold; font-size: 30px;">תיצור איתנו קשר</div>
		...
		<form action="send_mail.php" method="post" id="contactform">
				<div class="mod-row form_page">
					<div class="row">
						<div class="col-md-8">	
							<div class="row temr">
								<label style='float:right'>שם פרטי:</label>
							</div>
							<div class="row temr">
						...
						<div class="col-md-8">	
							<div class="row temr">
								<label style='float:right'>דוא"ל:</label>
							</div>
							<div class="row temr">
					...
					<div class="row">
						<div class="col-md-8">	
							<div class="row temr">
								<label style='float:right'>טלפון:</label>
							</div>
							<div class="row temr">
						...
						<div class="col-md-12">	
							<button class="submit" type="submit" name="Submit" value="Submit Request" style="margin-left: 49.5%;">שלח </button>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		// alert('hi');
		$("#contactform").validationEngine('attach', { promptPosition: "topLeft" });
	});
