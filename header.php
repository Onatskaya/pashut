            ...
            */
            ...
            <div class="navbar-collapse collapse" id="navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    {
                        ?>
                        <li class="post"><em></em><a href="join.php">PLServices</a></li>
                        <li class="post"><em></em><a href="post.php">Post Listing</a></li>
                        <?php
                    }
                    ?>
                    <li class="find"><em></em><a href="featured_listings.php">Moving Resources</a></li>
                    <!--								<li class="find"><em></em><a href="moving_resources_listings.php">Moving Resources</a>-->
                    </li>
                    <li class="dropdown">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <ul class="list-inline text-right">
                        ...
                        if(!isset($_SESSION['member_logged']))
                        { ?>
                            <li> <a href="contactus.php"><span class="join-banner" style="font-size: 16px;">Advertise with us!</span></a></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
