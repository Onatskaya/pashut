...
if($_SESSION['language']=='Hebrew')
{
	...
	echo "<script>location.href='edit_profile_h.php?$getto'</script>";
}
			...
			<form action="update_profile.php" method="POST" id="register">
				<div class="col-md-10">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<select class="input validate[required] form-control" name="mem_state">
								...
								{ ?>
									<option <?php if($data_state['state_name']==$data_mem['mem_state']) { echo 'selected'; } ?> ><?php echo $data_state['state_name'];?></option>
								<?php }
								?>
							</select>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<select class="input validate[required] form-control" name="ll_type">	
								<option <?php if($data_mem['ll_type']=='Individual') { echo "selected"; } ?> >Individual</option>
								<option <?php if($data_mem['ll_type']=='Property Management') { echo "selected"; } ?>>Property Management</option>	
								<option <?php if($data_mem['ll_type']=='Complex') { echo "selected"; } ?>>Complex</option>
								<option <?php if($data_mem['ll_type']=='Roommate') { echo "selected"; } ?>>Roommate</option>						
								<option <?php if($data_mem['ll_type']=='Other') { echo "selected"; } ?>>Other</option>								
								<option <?php if($data_mem['ll_type']=='Agent') { echo "selected"; } ?>>Agent</option>	
							</select>
						</div>
					</div>
					<br>
					<div class="row">
						...
						<div class="col-md-4"><input type="text" class="input validate[required] form-control" name="password" value="<?php echo $data_mem['password'];?>"></div> -->
					</div>
					<br>
					<div class="row">
