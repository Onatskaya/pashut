...
if($_SESSION['language']=='Hebrew')
{
	...
	echo "<script>location.href='view_post_detail_h.php?$getto'</script>";
}
$pid= $_GET['pid'];
	...
	<div class="col-md-12" align="center">
		...
		<div class="col-md-8">
			...
			<div class="listing-info">
				...
				<div class="row even">
					<div class="col-md-6">
						<strong>Phone No. </strong><?php echo $data['contact_a'].'-'.$data['contact_a'].'-'.$data['contact_c'] ;?> &nbsp; Ext <?php echo $data['contact_d']; ?>
					</div>
					<div class="col-md-6">
				...
				<div class="row odd">
					<div class="col-md-6">
						<div class=" extra_padding">
							...
							<span itemtype="http://schema.org/PostalAddress" itemscope="" itemprop="address"><span itemprop="addressLocality"><?php $WHERE_CITY['city_id']=$data['city']; echo select('city',$WHERE_CITY)[0]['city_name'];?></span>, <span itemprop="addressRegion"><?php $WHERE_STATE['id']=$data['state']; echo select('state',$WHERE_STATE)[0]['state_name'];?></span></span>
				...
				<div class="row even">
					...
					<div class="col-md-6">
						<strong>Vacany Heading:</strong><?php echo $data['short_descp'];?>
					</div>
					<div class="col-md-6">
						<strong>Vacany Description:</strong><?php echo $data['full_descp'];?>
					</div>
				</div>
				<div class="row even">
					<div class="col-md-6">
				...
				<div class="row" align="center">
					<a href="edit_post.php?pid=<?php echo $data['post_id'];?>" class="btn btn-danger">Edit</a>
				</div>
				...
				<!-- <div class="row odd">
					<div class="col-md-6">
						...
						<div class="col-md-4">
							...
							if($data['property_available']!='Available')
							{ ?>
								<a href="relist.php?pid=<?php echo $pid; ?>" class="applyLink">Relist Property</a>
							<?php
							}
							?>
							</div>
							<div>	
								...
								if($data['property_available']=='Available')
								{ ?>
									<button class="applyLink" id="prty_rnt">Property Rented</button>
								<?php }	
								?>
