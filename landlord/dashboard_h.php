...
if($_SESSION['language']=='English')
{
	...
	echo "<script>location.href='dashboard.php?$getto'</script>";
}
			...
			<div class="center-mod">
				...
				<div class="current-list">
					<h3>
						...
						רישומים בשידור חי
						<span style="" class="subtext">-<?php echo $row_ll; ?> רֵיק </span>
						<span style="float:left" class="create-link"><a href="add_post.php">צור רישום חדש</a></span>
					...
					<div class="body">
						...
						if($row_ll== 0)
						{ ?>
							<b>אין חדש רישום</b><br />
						<?php }
						else
						{ ?>
							<b><?php echo $row_ll; ?> רישום חדש</b><br />
						<?php	}
							?>
					</div>
				</div>
				...
				<div class="saved-list">
					<h3>
						רישומי מתוזמנות & שמורים
						<span class="subtext"> - <?php echo $row_ss; ?> מתוזמנות</span>
					</h3>
					<div class="body">
						<?php
						if($row_ss== 0)
						{ ?>
							<b>לא שמורים רשימה</b><br />
						<?php }
						else
						{ ?>
							<b><?php echo $row_ss; ?> רשימה שמורה</b><br />
					<?php	}
						?>
					</div>
				</div>
				...
				<div class="rented-list">
					<h3>
						רישומים הושכרו
						<span class="subtext"> - <?php echo $row_rl; ?> שָׂכוּר</span>
					</h3>
					<div class="body">
						<?php
						if($row_rl== 0)
						{ ?>
							<b>רישומים לא הושכרו</b><br />
						<?php }
						else
						{ ?>
							<b><?php echo $row_rl; ?> רישומים הושכרו</b><br />
						<?php	}
							?>
					</div>
				</div>
