...
<div class="col">
    ...
    <select name="city" style="width:32%;" class="medium right-pad">
        ...
        { ?>
            <option value='<?php echo $data_city['city_id'];?>' <?php checked($data_city['city_id'], $city_val ); ?>><?php echo $data_city['city_name'];?></option>
        <?php }
        ?>
    </select>
</div>
...
<div class="col s_field">
    ...
    <select name="bedroom" style="width:24%;" class="medium right-pad">
        ...
        { ?>
            <option value='<?php echo $data_bedroom['id']; ?>' <?php checked($data_bedroom['id'],$bedroom_val ); ?>><?php echo $data_bedroom['bedroom']; ?></option>
        <?php }
        ?>
    </select>
    ...
    <select name="bathroom" style="width:14%;" class="medium right-pad">
        ...
        { ?>
            <option value='<?php echo $data_bath['id'];?>' <?php checked($data_bath['id'],$bathroom_val ); ?>><?php echo $data_bath['bath'];?></option>
        <?php }
        ?>
    ...
    <select name="furnished" style="width:24%;" class="medium right-pad">
        ...
        {
            ?>
            <option value='<?php echo $data_fur['id'];?>' <?php checked($data_fur['id'], $furnished_val ); ?>><?php echo $data_fur['furnished'];?></option>
        <?php
        }
        ?>
    </select>
