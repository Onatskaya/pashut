...
<div class="container">
    <div class="llsignup">
        ...
        <h3>
            <div align="right"><a href="login2.php">Already Have an Account?</a></div>
        </h3>
        ...
        <ul>
            ...
            <?php /*?>			<li>PashutLehaskir.com supports Property Owners and <strong>each listing earns you money</strong>!</li><?php */ ?>
            <li>PashutLehaskir works directly with Property Owners & Renters.</li>
        ...
        <form action="landlordsignup2.php" method="post" name="llSignupForm" id="llSignupForm">
            ...
            <div class="mod-row">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" size="30" maxlength="50" class="input validate[required] form-control"
                               name="first_name">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="small" name="ll_phone_a" maxlength="3" onFocus="this.select()"
                               onBlur="this.value=chars(this.value,'1234567890');"
                               onKeyUp="if(this.value.length==3 && event.keyCode != 9 && event.keyCode != 16)this.form.ll_phone_b.focus();">

                        <input type="text" class="small" name="ll_phone_b" maxlength="3" onFocus="this.select()"
                               onBlur="this.value=chars(this.value,'1234567890');"
                               onKeyUp="if(this.value.length==3 && event.keyCode != 9 && event.keyCode != 16)this.form.ll_phone_c.focus();">

                        <input type="text" class="small" name="ll_phone_c" maxlength="4" onFocus="this.select()"
                               onBlur="this.value=chars(this.value,'1234567890');">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="mod-row">
                <div class="row">
                    <div class="col-md-8">
                        <div class="line"><input type="Checkbox" class="checkbox" name="llterms" value="1"> I have read
                            and understood the <A href="../ll_terms.htm" target="_blank">Terms of Use</a> of
                            pashutlehaskir.com
                        </div>
                        <div class="line"><input type="Checkbox" class="checkbox" name="nofc" value="1"> I agree my
                            property is not in foreclosure
                        </div>
                        <div class="line"><input type="checkbox" class="checkbox" name="credit_check" value="1"> I am
                            interested in receiving Emails & Newsletter about PashutLeHaskir.com
                        </div>
                        <div class="line"><input type="checkbox" class="checkbox" name="pm_brokerage" value="1"> I am
                            interested in learning more about leasing services and how PashutLeHaskir.com can help me
                            rent my place!
                        </div>
                    </div>
            ...
            <div class="mod-row">
                <input type="submit" value="Create Account" class="btn"
                       style="width:20% ; background-color:#0074E4; color:#fff;" name="btSafeSubmit" id="join-plh">
            </div>
...
<div id="dropmenudiv" style="visibility:hidden;width:165px;background-color:lightyellow" onmouseover="clearhidemenu()"
...
<script language="javascript" src="js/jquery_002.js" type="text/javascript"></script>
<script language="javascript" src="js/signup.js" type="text/javascript"></script>
<style type="text/css">
    .preferences-content {
        display: none
    }
...
<script language="javascript" src="js/fb_signup.js" type="text/javascript"></script>
