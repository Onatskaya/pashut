            ...
            <div class="gridModule" style="height:470px;">
				...
				<div class="body">
					<form name="loginForm" id="loginForm" action="login.php" method="post" onsubmit="return _CF_checkloginForm(this)">
						<div class="row">
							<input name="username" id="username"  type="text" maxlength="100"  onkeyup="if(submitEnter(this,event)) login(this.form)"  placeholder="שם משתמש"  />
						</div>
						<div class="row">
							<input name="password" id="password"  type="password" maxlength="20"  onkeyup="if(submitEnter(this,event)) login(this.form)"  placeholder="סיסמה"  />
						</div>
						<div class="row" align="center">
							 <input type="submit" name="btn-login" class="btn_login" value="התחבר" />
						</div>
					</form>
				</div>
			</div>
					...
					<div class="body">
						...
						<form action="passwordReminder.php" name="reminderForm" method="post">
							<div class="row">
								...
								<input type="text"  name="verify" placeholder='כתובת דוא"ל' maxlength="100">
								
								<input type="submit" name="submit" value='דוא"ל ססמה' class="btn_login" />  
							</div>
						</form>
					</div>
