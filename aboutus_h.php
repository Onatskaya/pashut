	...
	<div class="row">
		...
		<div class="col-md-8">
				...
				<br>
					...
					<p >
						<b> "פשוט להשכיר" </b> הינו ממשק מהפכני לשירות מקוון של השכרת נכסים בישראל. האתר מציע את הכלים הדרושים הן לשוכרים והן לבעלי נכסים לשכור ולהשכיר נכסי נדל"ן ביעילות ובמהירות, תוך התמקדות חזקה במידע מעודכן על הנכסים, תמונות מדויקות ומאושרות, מדדים מקיפים ומידע על הבניינים, בנוסף לממשק משתמש קל ופשוט.
					</p>
					<br><br>
					<p >
						<b>בהשוואה לסוכני הנדל"ן הסטנדרטיים בישראל, שוכרי "פשוט להשכיר"  <span style="color:#D84A38;">חוסכים בממוצע 70%</span> מהעמלות באמצעות שימוש בשירות שלנו.</b>
					</p>
					<br><br>
					<p >
						<b>עבור בעלי נכס</b>, "פשוט להשכיר" מספקת <span style="color:#D84A38;">הכנסה עבור כל מודעה</span>, מבטיחה רמה גבוהה יותר של דיירים, אפשרויות תיאום מיידי להצגת הנכס, ותמונות פנימיות של הנכס להשכרה.

					</p>
					<p>
						<b>עבור שוכרים</b>, "פשוט להשכיר" משלבת את המידע המדויק ביותר הקיים בשוק הנדל"ן על נכסים, תמונות וסרטונים מסוננים ומאושרים מראש, אפשרויות תיאום מיידי ונוח לביקור בנכס, וממשק קל ופשוט לשימוש, עבור מציאת נכס מתאים במהירות.
					</p>	
					<br><br>
					<p >
						<b>"פשוט להשכיר" מיצבה את עצמה כשירות האמין ביותר בשוק עבור חיבור בין בעלי נכס ודיירים בישראל.</b>
					</p>
		</div>
