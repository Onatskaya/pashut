...
<!-- 	<img src="images/new/footer-bg.png">
	...
	<div class="llsignup">
		...
		<h3><div align="left"><a href="login2.php">כבר יש לך חשבון?</a></div></h3>
		<h2 style="text-align: right">פרסמו נכס בחינם.</h2>
		
		
		<h3 style="text-align:right">למה לפרסם ב"פשוט להשכיר"?</h3>
		<ul>
			<li style="text-align: right;">  מערכת החברות שלנו מבטיחה <strong>שוכרים ברמה גבוהה יותר</strong>.מערכת החברות שלנו <strong>מבטיחה שוכרים ברמה גבוהה יותר</strong>.</li> 
			<li style="text-align: right;">"פשוט להשכיר" תומך בבעלי נכסים, ואתם <strong>מרוויחים כסף עבור כל מודעה!</strong></li>
			<li style="text-align: right;">צוותי התמיכה המנוסים שלנו ילוו אותך לאורך כל תהליך פרסום המודעה.</li> 
			<li style="text-align: right;">אפשרות המודעות הנבחרות יוצרת <strong>גל של צפיות רבות</strong> במודעות שלך.</li>
		</ul>
		<hr clas="featured">
		<form action="landlordsignup2.php" method="post" name="llSignupForm" id="llSignupForm">
				...
				<div class="mod-row">
					...
					<div class="row">
						<div class="col-md-4">	
							<label style="text-align:right">מיקוד:</label>
							<input type="text" size="7" maxlength="10" name="ll_zipcode" class="">
						</div>
						<div class="col-md-4">	
							<label style="text-align:right">מדינה:</label>
							<select name="ll_state" class="small">
								<option >AL</option>
							</select>
						</div>
						<div class="col-md-4">	
							<label style="text-align:right">עיר:</label>
					...
					<div class="row highlight">
						<div class="col-sm-offset-2 col-md-3">
							<select name="landlord_type_id">
								...
								<option>ניהול נכס</option>
								
								<option>קומפלקס</option>
						...
						<div class="col-md-7">	
							<label style="text-align:right">נא בחר את סוג החשבון שלך</label>
						</div>
					</div>
					
					<div class="row">
						<div class="col-md-4">	
							<label style="text-align:right">אימות סיסמה:</label>
							<input type="password" autocomplete="off" name="password2" maxlength="20">
						</div>
						<div class="col-md-4">	
							<label style="text-align:right">סיסמה:</label>
							<input type="password" autocomplete="off" name="password" id="password" maxlength="20">
						</div>
						<div class="col-md-4">	
							<label style="text-align:right">שם משתמש:</label>
							<input type="text" name="username" maxlength="100">								
							<div id="response"></div>
							<div style="text-align:right"><a  id="check-username" >בדוק זמינות</a></div>
						</div>
					</div>
				...
				<div class="mod-row">
					<div class="row">
						...
						<div class="col-md-11" style="text-align:right" >
							<div class="line"> קראתי והבנתי את תנאי השימוש של "פשוט להשכיר"<A href="../ll_terms.htm" target="_blank">תנאי שימוש</a> of pashutlehaskir.com </div>
							<div class="line"> אני מצהיר כי הנכס שלי אינו מעוקל </div>
							<div class="line"> אני מועניין בקבלת חדשות ועדכונים בדוא"ל מ"פשוט להשכיר" </div>
							<div class="line">אני מעוניין לקבל מידע נוסף על שירותי ליסינג, ואיך ניתן להשכיר את הנכס שלי עם "פשוט להשכיר"! </div>
							<div class="line">
								<br />
      ...
      <div style="width: 300px; height: 60px; border-style: none;
        ...
        <textarea id="g-recaptcha-response" name="g-recaptcha-response"
                  ...
                  style="width: 250px; height: 40px; border: 1px solid #c1c1c1;
						...
						<div class="col-md-1"  >
							<div class="line"><input type="Checkbox" class="checkbox" name="llterms" value="1"><br></div>
							<div class="line"><input type="Checkbox" class="checkbox" name="nofc" value="1"><br></div>
							<div class="line"><input type="checkbox" class="checkbox" name="credit_check" value="1"><br></div>
							<div class="line"><input type="checkbox" class="checkbox" name="pm_brokerage" value="1"><br></div>
							<div class="line"></div>
						</div>
				...
				<div class="row ">
					<input type="submit" value="צור חשבון" class="btn" style="width:20% ; background-color:#0074E4; color:#fff; float: right; margin-right: 5%;" name="btSafeSubmit" id="join-plh">
				</div>
