...
{
	echo "<script>location.href='aboutus_h.php'</script>";
}
?>
...
<div class="container public">
	...
	<div class="row">
		...
		<div class="col-md-8">
					...
					<br><br>
					<p>
						<b>PashutLeHaskir.com has positioned itself as the most trusted marketplace for connecting landlords and tenants in Israel.</b>
					</p>
		</div>
