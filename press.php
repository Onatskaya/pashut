...
<!-- End Google Tag Manager --> 
		...
		<div id="slidedown-content" data-status="hide" class="none">
			<div id="login-content" class="fb">
				...
				<a href="townhouses/mid-wilshire-townhouses/www_westsiderentals_default.html" class="fb-login"><img src="images/fblogin.png"></a>
				</div>
			</div>		
		</div>
...
<div class="container member-dash">
		
	<div class="col-md-12">
		<br><h3>Please direct all Press inquiries to:</h3>

		Kevin Miller<br>
		President, pashutlehaskir.com<br>
		<a href="mailto:kevin@pashutlehaskir.com">kevin@pashutlehaskir.com</a><br>
		Telephone: 310-576-1470<br /> 
	</div>
</div>
